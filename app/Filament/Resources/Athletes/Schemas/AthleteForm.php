            ...
            ->components([
                Grid::make(1)->schema([
                    ...
                    FileUpload::make('avatar')
                        ->label('Foto Atlet')
                        ->image()
                        ->imageEditor() // optional (crop)
                        ->directory('athletes/avatars')
                        ->disk('public')
                        ->visibility('public')
                        ->maxSize(2048) // 2MB
                ...
                Grid::make(2)->extraAttributes(['class' => '-mt-6'])->schema([
                    TextInput::make('name')
                        ->label('Nama Atlet')
                        ->required(),
                    ...
                    Placeholder::make('status_display')
                        ...
                        ->visible(fn ($livewire, $record) =>
                            filled($record) &&
                            ! ($livewire instanceof ViewAthlete) &&
                            ! ($livewire instanceof EditAthlete)
                        ),
